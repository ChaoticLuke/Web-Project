...
export default function About() {
    return (
        <div className="md:ml-10">
            ...
            <div className='m-10'>
                <img className=' lg:float-right sm:ml-10 sm:mr-20 sm:w-3/5 sm:h-3/5 lg:w-3/12 lg:h-3/12  sm:shadow-lg border-8 border-mossgreen rounded-xl mx-auto' src="Sheo_12_GreyFluff.jpeg" alt="Tan scuffs"></img>
            </div>
