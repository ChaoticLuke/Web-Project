    ...
    <div>
        <div className='bg-[url("/Wave_main.svg")] h-full w-full pt-20 bg-center bg-cover bg-no-repeat sm:pl-10'>
            ...
            <button className='sm:justify-between flex content-center justify-center items-center font-medium sm:mx-10 mb-96 mx-auto '>
              <a href="/showcase" className="top rounded-full font-bold py-2 px-12 cursor-pointer tracking-wide uppercase shadow-2xl mt-5 text-2xl duration-75 delay-50 hover:text-light hover:bg-lpeach bg-peach border-4 border-mossgreen focus:border-ltmossgreen shadow-xl">View all</a>
            </button>
            <br/>
        </div>
