  ...
  return (
    <div>
        ...
        <div className='lg:m-5 mt-5 backmain border-4 md:border-8 rounded-lg border-peach clearfix'>
            <div className='p-4 md:p-0'>
              <Image className='mx-auto md:float-right clearfix md:2/5 xl:h-1/3 md:w-4/12 xl:w-3/12 border-4 md:border-8 border-lpeach rounded-xl m-4 shadow-lg md:mr-16' src="/Sheo_5_BlackSlipOns.jpeg" alt="Slipper with 3 diffrent colours, dark blue, grey and scarlett" width={500} height={500}/>
            </div>
