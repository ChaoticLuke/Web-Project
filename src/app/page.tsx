  ...
  return (
    <div>
      <div>
        ...
        <div className=' m-0 lg:m-10 bg-gray-200 border-8 border-green-700  '>
        <Image className='float-none lg:float-right mt-3 lg:m-4 ' src="placeholder_about.svg" alt="dash2" width={700} height={400}/>
          ...
          <h1 className="text-left text-7xl lg:text-8xl mb-1 ml-1 font-bold px-8 ">Slippers</h1>
        ...
        <Image className='float-none lg:float-right mt-3 lg:m-4 ' src="placeholder_about.svg" alt="dash2" width={700} height={400}/>
          <h1 className="text-6xl mt-24 mb-1 ml-1 font-light px-8 text-center sm:text-left">Look at my</h1>
